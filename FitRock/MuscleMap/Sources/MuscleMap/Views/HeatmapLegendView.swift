...
public struct HeatmapLegendView: View {
    ...
    public init(
        ...
        self.labelMin = labelMin ?? NSLocalizedString("legend.low", bundle: .main, comment: "")
        self.labelMax = labelMax ?? NSLocalizedString("legend.high", bundle: .main, comment: "")
    ...
    public var body: some View {
        if orientation == .horizontal {
            horizontalLayout
                ...
                .accessibilityLabel(NSLocalizedString("accessibility.heatmapLegend", bundle: .main, comment: ""))
        } else {
            verticalLayout
                .accessibilityElement(children: .combine)
                .accessibilityLabel(NSLocalizedString("accessibility.heatmapLegend", bundle: .main, comment: ""))
