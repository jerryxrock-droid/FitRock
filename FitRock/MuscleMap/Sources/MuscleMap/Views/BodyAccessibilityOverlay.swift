...
struct BodyAccessibilityOverlay: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel(NSLocalizedString("accessibility.bodyMap", bundle: .main, comment: ""))
    }
    ...
    private func accessibilityElement(for item: MuscleAccessibilityItem) -> some View {
        ...
        Color.clear
            ...
            .accessibilityValue(NSLocalizedString(valueKey, bundle: .main, comment: ""))
            .accessibilityHint(NSLocalizedString(hintKey, bundle: .main, comment: ""))
            .accessibilityAddTraits(traits)
            .accessibilityAction(.default) {
                onMuscleSelected?(item.muscle, .both)
            }
            .accessibilityAction(named: Text(NSLocalizedString("accessibility.hint.longPress", bundle: .main, comment: ""))) {
